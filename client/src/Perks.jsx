export default function Perks({selected, onChange}) {
    ...
    return (
        <>
            ...
            <label className="flex rounded-2xl gap-2 items-center border p-4 cursor-pointer">
                <input name="Free parking spot" type="checkbox" onChange={handleCheckboxClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="flex rounded-2xl gap-2 items-center size-6">
            ...
            <label className="flex rounded-2xl gap-2 items-center border p-4 cursor-pointer">
                <input name="Entrance" type="checkbox" onChange={handleCheckboxClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="flex rounded-2xl gap-2 items-center size-6">
